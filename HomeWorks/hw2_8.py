...
connect_to_db = create_connection('''homework.db''')
if connect_to_db is not None:
    ...
    # insert_student(connect_to_db, ('Tilek','Kudayarov'))
    # insert_student(connect_to_db, ('Sergey', 'Vishnevskiy'))
    ...
    # insert_student(connect_to_db, ('Tom', 'Crus'))
